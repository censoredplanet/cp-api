...
// CenalertTimeseries is the resolver for the cenalertTimeseries field.
func (r *queryResolver) CenalertTimeseries(ctx context.Context, rangeArg *model.DateRange, country string) ([]*entities.CenAlertTimeSeries, error) {
	return r.Service.CenAlertTimeSeries(ctx, rangeArg, country)
}

// CenalertCountries is the resolver for the cenalertCountries field.
func (r *queryResolver) CenalertCountries(ctx context.Context) ([]string, error) {
	return r.Service.CenAlertCountries(ctx)
}

// CenalertEvents is the resolver for the cenalertEvents field.
func (r *queryResolver) CenalertEvents(ctx context.Context, rangeArg *model.DateRange, country *string) ([]*entities.CenAlertEvents, error) {
	return r.Service.CenAlertEvents(ctx, rangeArg, country)
}
